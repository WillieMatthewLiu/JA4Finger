# Capability: JA4 Client Fingerprinting

## Purpose

Define the shared packet-processing and emission requirements for JA4T, JA4, and JA4H fingerprints produced from client traffic.
