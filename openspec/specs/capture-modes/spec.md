# Capability: Capture Modes

## Purpose

Define the supported runtime entrypoints, daemon configuration model, and live/offline capture behavior for the `ja4finger` binary.
